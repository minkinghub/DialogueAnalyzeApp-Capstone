...
import getUserInfo from '../API/login/GetUserInfo'; //카카오 유저정보 반환 컴포넌트
import SendServer from '../API/login/SendServer '; //유저정보 전송 컴포넌트
          ...
          <TouchableOpacity
            ...
            <View style={{marginLeft: 10, width: '35%'}}>
              <Image
                ...
                resizeMode="contain"
                source={require('../../../assets/images/naver_iconG.png')}
              />
            </View>
            <View style={{width: '65%'}}>
              <Text style={{color: '#FBFEFC', fontWeight: 'bold'}}>
                {' '}
                네이버 로그인
              </Text>
            </View>
