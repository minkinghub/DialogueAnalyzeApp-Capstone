...
import {GetToken} from '../utilities/tokenData/GetToken'; //전역관리 토큰 호출
import GenDateToServer from '../utilities/API/GenDateToServer'; //성별, 생년월일 서버연동
import FileChoice from './FileChoice'; //파일 선택 컴포넌트 경로
import {darkTheme, lightTheme} from '../stylesFile/theme.styles'; //테마 변경
import FileSendServer from '../utilities/API/analyze/FileSendServer';
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
      {mannerFileSend && (
        <FileSendServer
          ...
          dataType={dataType}
          onCompleted={resetMannerFileSend}
          resetFile={resetFile}
        />
      )}
        ...
        <View
          ...
          <View
            ...
            <Text
              style={{
                fontSize: 15,
                color: dataType === true ? '#4B0082' : '#FFFFFF',
              }}>
              텍스트
            </Text>
          </View>
          <View
            ...
            <Text
              style={{
                fontSize: 15,
                color: dataType === false ? '#4B0082' : '#FFFFFF',
              }}>
              음성
            </Text>
          </View>
