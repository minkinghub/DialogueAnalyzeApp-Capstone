...
smg_df = pd.read_csv("./Data/smilestyle_dataset.tsv", sep="\t")
chat_df = pd.read_csv('./Data/aihub_sentiment_dataset.tsv', sep='\t')

BASE_DIR = Path(__file__).resolve().parent.parent
EXPORT_DIR = BASE_DIR.joinpath("politely", "Data")
...
chat_formal = df2sentence(chat_df, ['시스템문장1', '시스템문장2', '시스템문장3'])
chat_informal = df2sentence(chat_df, ['사람문장1', '사람문장2', '사람문장3'])
