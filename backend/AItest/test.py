...
if __name__ == "__main__":
    input_filename = "Deleted_Recipe3.csv"  # 원본 CSV 파일 이름
    output_filename = "Deleted_Recipe4.csv"  # 결과 CSV 파일 이름
    deleted_filename = "Deleted_Data4.csv"  # 삭제된 부분을 저장할 외부 파일 이름
